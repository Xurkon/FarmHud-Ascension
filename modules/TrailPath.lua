...
local zoneNameToYards = {
    ["Stormwind City"] = 1000, ["Stormwind"] = 1000, ["Orgrimmar"] = 1200,
    ["Ironforge"] = 800, ["Thunder Bluff"] = 1000, ["Darnassus"] = 1000,
    ["Undercity"] = 1200, ["The Exodar"] = 1000, ["Silvermoon City"] = 1200,
    ["Shattrath City"] = 800, ["Dalaran"] = 600, ["Tirisfal Glades"] = 4000,
    ["Dun Morogh"] = 4000, ["Elwynn Forest"] = 3500, ["Westfall"] = 4000,
}
...
local function TrailPath_TickerFunc()
	...
	if trailPathActive[1] and trailPathActive[1].info and trailPathActive[1].info.x then
		local deltaX, deltaY, distance, angle = HBD:GetWorldVector(instance, trailPathActive[1].info.x, trailPathActive[1].info.y, x, y);
